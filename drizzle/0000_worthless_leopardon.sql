...
CREATE TABLE `Revo_Gyms` (
	...
	CONSTRAINT `Revo_Gyms_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE `Revo_Gym_Count` ADD CONSTRAINT `gym_reference` FOREIGN KEY (`gym_id`) REFERENCES `Revo_Gyms`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
